...
DROP DATABASE IF EXISTS thtap;
-- Create database
CREATE DATABASE IF NOT EXISTS thtap;
USE thtap;
...
VALUES 				(	'dangblack'		,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'Nguyen Hai'	,	'Dang'		,		'ADMIN'		,		'5'			),
					(	'minhvuong'		,   '$2a$10$W2neF9.6Agi6kAKVq8q3fec5dHW8KUA.b0VSIGdIZyUravfLpyIFi'	,	'Minh'	,	'Vuong'		,		'ADMIN'		,		'5'			),
